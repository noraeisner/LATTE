...
subroutine flux_tr(xd,trlab,pars,rps,ldc,&
           n_cad,t_cad,nbands,nradius,datas,npl,muld)
use constants
implicit none

!In/Out variables
  integer, intent(in) :: datas, npl, nbands, nradius
...
subroutine flux_tr_band(xd,pars,ldc,&
...
subroutine find_chi2_tr(xd,yd,errs,trlab,jtrlab,pars,rps,ldc,jtr,flag, &
           n_cad,t_cad,chi2,datas,nbands,nradius,njtr,npl)
use constants
implicit none

!In/Out variables
  integer, intent(in) :: datas, npl, nbands,nradius, njtr
  integer, intent(in) :: n_cad(0:nbands-1)
...
!Local variables
  real(kind=mireal), dimension(0:datas-1) :: res
    ...
    call find_res_tr(xd,yd,trlab,pars,rps,ldc,flag, &
           n_cad,t_cad,res,datas,nbands,nradius,npl)
