...
If the code doesn't run when you first install it, this could be due to an SSL issue. To check, please try executing the following command in from your command line: **python -m tess_stars2px -t 261136679**
